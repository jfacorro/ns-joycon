 ...
 */
export declare function enableIMU(hid: HID, manageHandler: Function, enable: boolean): Promise<void>;
/**
 ...
 */
export declare function setInputReportMode(hid: HID, manageHandler: Function, mode: InputReportMode): Promise<void>;
/**
 ...
 */
export declare function enableVibration(hid: HID, manageHandler: Function, enable: boolean): Promise<void>;
